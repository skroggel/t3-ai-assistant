...
#[AsCommand(
    name: 'aiassistant:index:pages',
    description: 'Index pages and their content into Qdrant.'
)]
/**
 * Class IndexPagesCommand
 *
 * Console entrypoint for the page indexer. The command only builds a request and delegates to the indexing domain.
 *
 ...
 */
final class IndexPagesCommand extends Command
{
    /**
     * Constructor.
     *
    ...
    protected function configure(): void
    {
        $this
            ...
            ->addOption('force', null, InputOption::VALUE_NONE, 'Re-index all sources even when unchanged')
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $request->setOnlyChanged(!(bool)$input->getOption('force'));
        $request->setLimit(max(1, (int)$input->getOption('limit')));

        try {
            $result = $this->indexingCommandRunner->run('aiassistant.indexer.page', $request);
