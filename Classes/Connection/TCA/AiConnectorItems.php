...
class AiConnectorItems
{
    ...
    /**
     * Adds registered AI connectors to the TCA item list.
     *
    ...
    /**
     * Appends registered AI connectors to the given TCA parameters.
     *
     * @param array<string, mixed> $parameters TCA parameters.
     * @return void
     */
    protected function appendItems(array &$parameters): void
    {
        ...
        foreach (array_keys($this->aiConnectorRegistry->all()) as $identifier) {
            /**
