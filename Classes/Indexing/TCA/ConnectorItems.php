 ...
 *
 * Provides registered indexing connectors as TCA select items.
 *
...
final class ConnectorItems
{
    ...
    /**
     * Adds registered connectors to the TCA item list.
     *
    ...
    /**
     * Appends registered connectors to the given TCA parameters.
     *
     * @param array<string, mixed> $parameters TCA parameters.
     * @return void
     */
    protected function appendItems(array &$parameters): void
    {
        ...
        foreach ($this->connectorRegistry->all() as $connector) {
            $identifier = trim($connector->getIdentifier());
